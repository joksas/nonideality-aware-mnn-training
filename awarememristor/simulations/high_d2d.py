...
def get_ideal_iterator():
    return custom_iterator(devices.ideal(), [devices.high_magnitude_more_uniform_d2d()])


def get_nonideal_iterators():
    return [
        custom_iterator(
            devices.high_magnitude_more_uniform_d2d(), [devices.high_magnitude_more_uniform_d2d()]
        ),
    ]
